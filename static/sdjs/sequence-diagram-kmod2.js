...
! function() {
    ...
    if (_.extend(BaseTheme.prototype, {
        ...
        var xmlns = "http://www.w3.org/2000/svg",
            ...
            SnapTheme = function(diagram, options, resume) {
                _.defaults(options, {
                    "css-class": "simple",
                    "font-size": 16, //kmod font-size changed from 16 to 12
    ...
    Diagram.themes.hand = Diagram.themes.snapHand, Diagram.themes.simple = Diagram.themes.snapSimple, Diagram.prototype.drawSVG = function(container, options) {
        var defaultOptions = {
            theme: "hand"
        };
